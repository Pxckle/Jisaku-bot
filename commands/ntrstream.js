module.exports = [{
  name: "ntrstream",
  code: `
  $title[1;Snickerstream: NTR Streaming Client;https://gbatemp.net/threads/snickerstream-unified-ntr-and-hzmod-streaming-client-for-the-3ds.488374/]
  $description[1;
...
Snickerstream [app download](https://github.com/RattletraPM/Snickerstream/releases/tag/v1.10)
